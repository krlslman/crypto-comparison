            ...
            Price: {
                options: {
                    ...
                    grid: {
                        ...
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "#28edff"
                        }
                    }, stroke: {
                        curve: 'smooth',
                        width: 1.5,
            ...
            ,Market_Cap: {
                options: {
                    grid: {
                        ...
                        text: "Market Cap (USD)",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: '#00eea5'
                        }
                    }, stroke: {
                        curve: 'smooth',
                        width: 1,
            ...
            Tot_Vol: {
                options: {
                    grid: {
                        ...
                        text: "Market Volume",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "#ac63ff"
                        }
                    }, stroke: {
                        curve: 'smooth',
                        width: 1,
               ...
               <div className="container chart-section">
                    <div className="row">
                        ...
                        <div className="col" style={{ maxWidth: '200px' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title"> Price Change 24hrs </h6>
                                <p className="card-text fw-bold "
                                    style={{ color: 'rgb(255, 255, 255)', fontSize: 'small' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title"> Twitter Followers</h6>
                                <p className="card-text fw-bold "
                                    style={{ color: 'rgb(255, 255, 255)', fontSize: 'small' }}>
                                    {this.props.twitterF}
                                </p>
